...
console.log(date);
    ...
    {
 tipElement.innerHTML = "<details name='chatgpt'><summary style='font-size: 9pt;color: red;'>" + doc.data().content.substr(0,30) + " ... By: " + doc.data().name  + "</summary><p>" + doc.data().content + "</p><p style='font-size: 10px;color: grey;'>created by: " + doc.data().name + "," + date + "</p>";
  }else{
 tipElement.innerHTML = "<details name='chatgpt'><summary style='font-size: 9pt;color: red;'>" + doc.data().content.substr(0,30) + " ... By: " + doc.data().name + "</summary><p>" + doc.data().content + "</p><p><a href='" + doc.data().url + "' target='_blank'>Click here to view ChatGPT conversation!</a></p><p style='font-size: 10px;color: grey;'>created by: " + doc.data().name + "," + date + "</p>";
  }
