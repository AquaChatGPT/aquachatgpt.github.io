...
console.log(date);
    ...
    {
 tipElement.innerHTML = "<h3>" + doc.data().name + "</h3><p>description:<br>" + doc.data().content + "</p><p style='font-size: 10px;'>" + date + "</p>";
  }else{
 tipElement.innerHTML = "<h3>" + doc.data().name + "</h3><p>description:<br>" + doc.data().content + "</p><p><a href='" + doc.data().url + "' target='_blank'>link</a></p><p style='font-size: 10px;'>created: " + date + "</p>";
  }
