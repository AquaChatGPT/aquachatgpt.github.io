...
console.log(date);
    ...
    {
 tipElement.innerHTML = "<h3>" + doc.data().name + "</h3><p style='font-size: 12px;color: #1e19d5;'>description:</p><p>" + doc.data().content + "</p><p style='font-size: 10px;color: grey;'>created: " + date + "</p>";
  }else{
 tipElement.innerHTML = "<h3>" + doc.data().name + "</h3><p style='font-size: 12px;color: #1e19d5;'>description:</p><p>" + doc.data().content + "</p><p><a href='" + doc.data().url + "' target='_blank'>link</a></p><p style='font-size: 10px;color: grey;'>created: " + date + "</p>";
  }
